...
#define KC_CTES  CTL_T(KC_SPC)
#define KC_SFSP  SFT_T(KC_BSPC)
#define KC_ALBS  ALT_T(KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------|
     KC_LSFT,KC_LCTL,KC_LGUI,KC_LALT,  LOWER,KC_CTES,   KC_SFSP,  RAISE,KC_ALBS,KC_RCTL,KC_LGUI,KC_ENT \
  //|-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-------|
  ),
  ...
  //|-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------|
      KC_TAB,KC_TILD,XXXXXXX,KC_GESC,XXXXXXX,                   KC_LEFT,KC_DOWN,  KC_UP,KC_RGHT, KC_ENT,\
  //|-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------|
